            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem', marginBottom: '1.1rem' }}>
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 12,
                  padding: '0 clamp(0.9rem, 4vw, 1.75rem)',
                  fontSize: '1rem',
                  fontWeight: 600,
                  whiteSpace: 'nowrap',
                  cursor: 'pointer',
              ...
              >
                {/*
                  Apple logo mark downloaded from Apple Design Resources
                  (Sign in with Apple - Left Aligned - Black - Medium), used
                  unmodified per the Sign in with Apple HIG: height matched to
                  the button's own height, no crop, no added padding.
                */}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/apple-signin-logo.svg" alt="" aria-hidden="true" style={{ height: 48, width: 'auto', display: 'block', flexShrink: 0 }} />
