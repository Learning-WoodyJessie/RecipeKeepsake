...
export default function AppTopBar({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    ...
    >
      {/* ── Top row: hamburger | brand | greeting | avatar ── */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.85rem 1.75rem' }}>
        ...
        <div className="rk-search-desktop" style={{ flex: 1, maxWidth: 520, position: 'relative', display: 'flex', alignItems: 'center' }}>
        ...
        <style>{`
          .rk-search-desktop { display: flex; }
          @media (max-width: 699px) { .rk-search-desktop { display: none !important; } }
        `}</style>
      ...
      {/* ── Mobile search row ── */}
      <div className="rk-search-mobile" style={{ display: 'none', padding: '0 1rem 0.75rem' }}>
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
          ...
          <input
            ...
            style={{
              width: '100%',
              padding: q ? '0.6rem 2.4rem 0.6rem 2.5rem' : '0.6rem 0.85rem 0.6rem 2.5rem',
              borderRadius: 999,
              border: '1px solid var(--border2)',
              background: 'var(--cream)',
              fontSize: '0.88rem',
      ...
      <style>{`
        @media (max-width: 699px) { .rk-search-mobile { display: block !important; } }
      `}</style>
